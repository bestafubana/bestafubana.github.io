...
(function () {
	...
	describe('JHuntController...', function () {
		beforeEach(module('jHunt','store-directives'));
		...
		describe('View checks...', function () {
			...
			beforeEach(function(){
				$scope = {};
				controller = $controller('JHuntController', { $scope: $scope });
			});

			it('buttons should hide when ', function() {
		      var j1 = new Job(new Company("IVIA", "www.ivia.com.br"), 
	        		"www.vaguinhadukrai.com.br", "Encanador", 
	        		new ContactPerson("Biruleibe", "Gibson", "biru@gmail.com"),2, 0);

		      expect($scope.shouldHide(j1, 0)).toEqual(false);
		    });
		});
	});
