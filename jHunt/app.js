(function() {
  ...
  app.controller('JHuntController', ['$scope','$http','$sce',function($scope,$http,$sce){
    ...
    $scope.init = function(){
      ...
      .error(function(data, status, headers, config) {
          $scope.error = "Your list of jobs could not be loaded.";
      });
    ...
    $scope.shouldHide = function(job, max){
      return job.statusIndex > max;
    };
